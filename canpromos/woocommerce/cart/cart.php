		...
		<tbody>
			...
			<tr class="avada-cart-actions">
				<td colspan="6" class="actions">
					...
					<button type="submit" class="button" name="update_cart" value="<?php esc_attr_e( 'Updates cart', 'woocommerce' ); ?>"><?php esc_html_e( 'Update cart', 'woocommerce' ); ?></button>

					<a href="http://canpromos.ca/shop">Continue Shopping</a>
